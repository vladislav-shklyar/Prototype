...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="SobranieE.aspx.cs" Inherits="IIS.Product_47130.СобраниеE" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="<%= Constants.FormCssClass %> <%= Constants.EditFormCssClass %>">
        <h2 class="<%= Constants.FormHeaderCssClass %> <%= Constants.EditFormHeaderCssClass %>">Собрание</h2>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlТемаLabel" runat="server" Text="Тема" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlТема" runat="server">
</asp:TextBox>
