...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="KursE.aspx.cs" Inherits="IIS.Product_47130.КурсE" %>
...
<asp:TextBox CssClass="descTxt" ID="ctrlГод" runat="server">
</asp:TextBox>
...
<asp:RequiredFieldValidator ID="ctrlУниверситетValidator" runat="server" ControlToValidate="ctrlУниверситет"
ErrorMessage="Не указано: Университет" EnableClientScript="true" ValidationGroup="savedoc">*</asp:RequiredFieldValidator>
